...
import { TransformersJsLocalEmbeddingAdapter } from "../packages/ingestion-indexing/dist/index.js";
import {
...
if (
  !(profileVariant === "fp32" || profileVariant === "q8") ||
  artifactDirectory === undefined ||
  !isAbsolute(artifactDirectory) ||
  process.argv.length !== 4
) {
  console.error(
    "usage: node scripts/run-document-retrieval-resource-probe.mjs <fp32|q8> <absolute-asset-directory>",
  );
  process.exit(2);
}
