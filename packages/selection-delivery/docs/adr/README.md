...
0008은 **전체 대체**다. 부분 대체였던 위 두 사례와 다르다. 작성 당시의 최종 아키텍처 결정이
0002·0004·0006·0007 네 기록을 양립 불가로 판정하고 하나의 새 ADR에서 명시적으로 대체할 것을
요구했다. 역사적인 초안 파일·줄 번호 인용을 읽는 방법은 [`../decisions.md`](../decisions.md)의
인용 기준을 참고한다.
